<form class="block" action="{route:login_uri==undefiend?data:login_page:route:login_uri}" method="post">
	...
	<div style="display: {data:register_message!=null?'none':'block'};">
		...
		<input type="text" name="password" value="" size="128" placeholder="" tabindex="104" required autocomplete="off">
		<label>Confirm Password</label>
		<input type="text" name="confirm_password" value="" size="128" placeholder="" tabindex="105" required autocomplete="off">
