<form class="block" action="{route:login_uri==undefiend?data:login_page:route:login_uri}" method="post">
	...
	<label>Email</label>
	<input type="email" name="email" value="" placeholder="Email" size="255" tabindex="1" required>
	<label>Password</label>
	<input type="password" name="password" value="" size="255" placeholder="Password" tabindex="2" required>
