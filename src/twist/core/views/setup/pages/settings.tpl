<form class="inline foldable" action="user" method="post">
	...
	<label for="package-root">Package Folder Path</label>
	<span class="label">
		<span class="prefix">{data:relative_path}</span>
		<span class="input"><input type="text" name="package_path" placeholder="package" id="package-root" value="{data:package_path}"></span>
	</span>
