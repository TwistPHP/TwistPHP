<form class="block" action="{route:login_uri==undefiend?data:login_page:route:login_uri}" method="post" autocomplete="off">
	...
	<input type="password" name="current_password" value="" tabindex="1" size="35" placeholder="Current Password" required autocomplete="off">
	<label class="shadowPassword">Choose New Password</label>
	<input type="password" name="password" value="" tabindex="2" size="35" placeholder="New Password" required autocomplete="off">
	<label class="shadowConfirm">Confirm New Password</label>
	<input type="password" name="confirm_password" value="" tabindex="3" size="35" placeholder="Confirm Password" required autocomplete="off">
