<form class="block" action="{route:login_uri==undefiend?data:login_page:route:login_uri}" method="post" autocomplete="off">
	...
	<input type="email" name="forgotten_email" value="" maxlength="255" tabindex="201" placeholder="Email" required autocomplete="off" autofocus>
	<button type="submit" tabindex="202">Reset Password</button>
	<div class="clear"></div>
</form>