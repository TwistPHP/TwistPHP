<?php
	...
	* DIR_UPLOADS - Path to your packages folder, usually placed in your public_html folder
	*
	...
	*/
	...
	Twist::define('DIR_PACKAGES',DIR_BASE.'{data:packages_path}');
	Twist::define('DIR_UPLOADS',DIR_BASE.'{data:uploads_path}');