<li class="{data:licence/disabled} {data:licence/current}"><a href="#">Licence<i class="fa {data:licence/icon}"></i></a></li><!--
--><li class="{data:checks/disabled} {data:checks/current}"><a href="#">System Checks<i class="fa {data:checks/icon}"></i></a></li><!--
--><li class="{data:database/disabled} {data:database/current}"><a href="#">Database Settings<i class="fa {data:database/icon}"></i></a></li><!--
--><li class="{data:settings/disabled} {data:settings/current}"><a href="#">Framework Configuration<i class="fa {data:settings/icon}"></i></a></li><!--
