...
Our model in this example is used to get and set details about fruits. Create a file called *Fruits.model.php* in the */app/Models* folder:
```php
<?php
...
Now we can update the Site controller and add the following methods:
```php
