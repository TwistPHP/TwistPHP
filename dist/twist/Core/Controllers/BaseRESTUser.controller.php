...
class BaseRESTUser extends BaseRESTKey{
    ...
    public function _authenticate(){
	    ...
	    $srtApiEmail = (self::$blRequestHeaderAuth) ? $_SERVER['HTTP_AUTH_EMAIL'] : $_REQUEST[(array_key_exists('Auth-Email',$_REQUEST)) ? 'Auth-Email' : 'auth-email'];
	    $srtApiPassword = (self::$blRequestHeaderAuth) ? $_SERVER['HTTP_AUTH_PASSWORD'] : $_REQUEST[(array_key_exists('Auth-Password',$_REQUEST)) ? 'Auth-Password' : 'auth-password'];
