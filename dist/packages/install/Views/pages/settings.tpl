<form class="inline foldable" action="{uri:./user}" method="post">
	...
	<label>Enforce www</label>
	<input name="site_www" type="checkbox"{session:twist-setup/settings/details/site_www=='1'?' checked':''} value="1">
	...
	<label>Enforce Protocol</label>
	<input name="http_protocol_force" type="checkbox"{session:twist-setup/settings/details/http_protocol_force=='1'?' checked':''} value="1">
	...
	<p>All paths are relative to the location of the twist folder</p>
	<input type="hidden" name="relative_path" value="{data:relative_path}">

	<label for="public-root">Site Root</label>
	<span class="label">
		<span class="prefix">{data:relative_path}</span>
		<span class="input"><input type="text" name="site_root" id="public-root" value="{data:site_root}"></span>
	</span>

	<label for="app-root">App Folder Path</label>
	<span class="label">
		<span class="prefix">{data:relative_path}</span>
		<span class="input"><input type="text" name="app_path" placeholder="app" id="app-root" value="{data:app_path}"></span>
	</span>

	<label for="packages-root">Packages Folder Path</label>
	<span class="label">
		<span class="prefix">{data:relative_path}</span>
		<span class="input"><input type="text" name="packages_path" placeholder="packages" id="packages-root" value="{data:packages_path}"></span>
	</span>

	<label for="uploads-root">Uploads Folder Path</label>
	<span class="label">
		<span class="prefix">{data:relative_path}</span>
		<span class="input"><input type="text" name="uploads_path" placeholder="uploads" id="uploads-root" value="{data:uploads_path}"></span>
	</span>
